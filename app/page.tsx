...
import DeveloperTools from "@/components/ui/DevelopersTools";
    ...
    <ThemeProvider attribute="class" defaultTheme="dark" enableSystem>
      <div className="min-h-screen p-8 pb-20 gap-16 sm:p-12 font-[family-name:var(--font-geist-sans)] bg-background text-foreground">
        <header className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-gray-500">
      ...
      <footer className="mt-16 text-center text-sm text-muted-foreground">
        <p>&copy; 2024 HTTP3. All rights reserved by Dev.</p>
      </footer>
    </ThemeProvider>
  );
}
